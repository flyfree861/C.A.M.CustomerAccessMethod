...
public class DataBaseHelper extends SQLiteOpenHelper
{
    ...
    public DbAnswerManager addNewConnection(ConnectionModel connectionModel)
    {
        ...
        cv.put(COLUMN_EXPIRE_DATE, connectionModel.getExpireDate());
        ...
        {
            if (TextUtils.isEmpty(connectionModel.getFacilityName()))
            {
               insertResult = updateConnection(connectionModel, COLUMN_FACILITY_NAME, connectionModel.getFacilityName());

            }

            else
            {
               insertResult = updateConnection(connectionModel, COLUMN_KIND_OF_VPN, connectionModel.getKindOfVpn());
            }
    ...
    public long updateConnection(ConnectionModel connectionModel, String column, String field)
    {
        String query =  column + "='" + field + "'";
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_FACILITY_NAME,    connectionModel.getFacilityName());
        cv.put(COLUMN_KIND_OF_VPN,      connectionModel.getKindOfVpn());
